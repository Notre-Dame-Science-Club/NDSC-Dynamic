  ...
  return (
    ...
    >
      <div className="relative max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="flex flex-col items-start gap-4">
            <div className="flex items-center gap-3">
              <Image src="/images/logo-2.0.png" alt="NDSC Logo" width={56} height={56} className="object-contain" />
              <div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              {["/", "/about", "/activities", "/publication", "/executives", "/olympiad", "/members"].map((href) => {
                const labels: Record<string, string> = { "/": "Home", "/about": "About Us", "/activities": "Activities", "/publication": "Publication", "/executives": "Executives", "/olympiad": "Olympiad", "/members": "Members" };
                return <Link key={href} href={href} className="text-sm transition-colors hover:text-[var(--blue)]" style={{ color: "var(--muted)" }}>{labels[href]}</Link>;
              })}
            </div>
          </div>
        ...
        <div className="pt-6 flex flex-col md:flex-row items-center justify-between gap-4 text-xs" style={{ borderTop: "1px solid var(--border)", color: "var(--muted)" }}>
